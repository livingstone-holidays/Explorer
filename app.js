...
.setHTML("<div color='#cfc'><h3>" + currentFeature.properties[config.popupInfo[0]] + "</h3></div><h4><b>Region: </b>" + currentFeature.properties[config.popupInfo[1]] + "</h4><h4><b>Property Type: </b>" + currentFeature.properties[config.popupInfo[2]] + "</h4>")  .addTo(map);
}
