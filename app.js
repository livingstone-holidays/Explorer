...
function createPopup(currentFeature) {
  ...
  const popup = new mapboxgl.Popup({ closeOnClick: true })
    .setLngLat(currentFeature.geometry.coordinates)
     .setHTML("<table><tr><th style='background-color:#F2E74D'>" + currentFeature.properties[config.popupInfo[0]] + "</th></tr><tr><td><h4><b>Region: </b>" + currentFeature.properties[config.popupInfo[1]] + "</h4></td></tr><tr><td><h4><b>Property Type: </b>" + currentFeature.properties[config.popupInfo[2]] + "</h4></td></tr></table>")
  .addTo(map);
}
